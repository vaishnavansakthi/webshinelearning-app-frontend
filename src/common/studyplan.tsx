        ...
        topics: [
            {
                ...
                contentList: [
                    {
                        topic: "Basics",
                        content: "HTML is the standard markup language for describing the structure of web pages.lorem",
                    },
                    {
                        topic: "Elements",
        ...
        topics: [
          {
            ...
            contentList: [
              {
                topic: "Color Theory",
                content: "Understanding the principles of color and its usage in UI design.",
              },
              {
                topic: "Typography",
                content: "Exploring the use of typography to enhance user experience.",
              },
              {
                topic: "Layout Design",
                content: "Learning how to create visually appealing and user-friendly layouts.",
              },
              {
                topic: "User Interaction",
                content: "Designing intuitive user interfaces with effective interaction patterns.",
              },
              {
                topic: "Prototyping",
          ...
          },
          {
            ...
            contentList: [
              {
                topic: "Figma",
                content: "Figma is a powerful tool for designing and prototyping user interfaces.",
              },    
              {
                topic: "Components",
                content: "Components are the building blocks of a Figma design.",
              }
            ]
          },
          {
            ...
            contentList: [
              {
                topic: "Adobe XD",
                content: "Adobe XD is a powerful tool for designing and prototyping user interfaces.",
              },    
              {
                topic: "Components",
                content: "Components are the building blocks of a Adobe XD design.",
              }
            ]
          },
          {
            ...
            contentList: [
              {
                topic: "Sketch",
                content: "Sketch is a powerful tool for designing and prototyping user interfaces.",
              },    
              {
                topic: "Components",
                content: "Components are the building blocks of a Sketch design.",
              }
            ]
          }
          // Add more topics for UI/UX Design study plan as needed
        ]
      }
