function UserCard({ title, subTitle, count }: { title?: string; subTitle?: string; count?: number }) {
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-[#404040] shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
