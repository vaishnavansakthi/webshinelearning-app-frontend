          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                <InputBlock onChange={handleChange} name="username"  text="Username" htmlFor="username" type="text" placeholder="John Victor" className="text-gray-400" />
                <InputBlock onChange={handleChange} name="email" text="Your email" htmlFor="email" type="email" placeholder="name@company.com" className="text-gray-400" />
                <InputBlock onChange={handleChange} name="password" text="Password" htmlFor="password" type="password" placeholder="••••••••" className="text-gray-400" />
                <InputBlock onChange={handleChange} name="mobileNumber" text="mobileNumber" htmlFor="mobileNumber" type="mobileNumber" placeholder="9865004188" className="text-gray-400" />
                ...
                <Button type={"submit"} text="Sign Up" color="primary" className="tracking-wide leading-normal" size="medium" />
